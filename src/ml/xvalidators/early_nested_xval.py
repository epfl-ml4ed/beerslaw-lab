...
# class EarlyNestedXVal(XValidator):
...
#         for f, (train_index, test_index) in enumerate(self._outer_splitter.split(sequences, labels)):
#             logging.info('- ' * 30)
...
#             self._write_predictions(y_pred, y_proba, y_test, test_indices)
