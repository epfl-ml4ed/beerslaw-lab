...
class CumulBreakFilter(BreakFilter):
    """Only retains the x% longest breaks.
    ...
    def __init__(self, sequencer: Sequencing, break_threshold: float):
        ...
        self._name = 'cumul ' + str(break_threshold) + ' break filter' 
        self._notation = 'cumul ' + str(break_threshold) + ' br'
