...
class LanguageSimpleStateSecondsLSTM(Sequencing):
    ...
    In this particular case, each feature will be made out of a vector encoding:
        - 1 if the language is german
        - 1 if the language is french
        ...
        - 1 if the action is conducted while the abosbrnace is off
