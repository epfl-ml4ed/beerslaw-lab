...
class ColourBreakSecondsLSTM(Sequencing):
    ...
    In this particular case, each feature will be made out of a vector encoding:
        ...
        vector at time t:
            ...
            4: (s + vector(t-1)[2]) / vector(t) no green laser or (no green solution and no red solution)
            5: (s + vector(t-1)[2]) / vector(t) no green laser or (no green solution and no red solution) and in break
            6: (s + vector(t-1)[3]) / vector(t) concentrationlab
