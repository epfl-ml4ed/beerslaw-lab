...
class ColourbreakFlat(Sequencing):
    ...
    In this particular case, each feature will be made out of a vector encoding:
        ...
        - whether the break was conducted in the green laser and green solution state
        - whether the action was conducted in the green laser and red solution state
        - whether the break was conducted in the green laser and red solution state
        - whether the action was not conducted in the above states
        - whether the break was not conduced in the above states
    ...
    def get_sequences(self, simulation:Simulation) -> Tuple[list, list, list]:
        ...
        new_begins, new_ends, new_labels = [], [], []
        new_begins.append(0)
        new_ends.append(begins[0])
        new_labels.append('break_nogreennored')
        ...
        for i, lab in enumerate(labels):
            ...
            if i+1 < len(labels):
                if begins[i + 1] - ends[i] > self._break_minimum:
                    nl = self._fill_vector([m_obs, sv, wl, rm, 'break'], begins[i+1] - ends[i], 'break_')
